...
(
    ...
    constraint fk_rol foreign key (name_rol) references cliente.rol (name)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_customer_user foreign key (login) references cliente.customer_user (login)ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    constraint fk_customer_user foreign key (login) references cliente.customer_user (login)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_tipo_documento foreign key (sigla) references cliente.tipo_documento (sigla)ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE table logs.log_errores(
    ...
    constraint fk_log_erro_cliente FOREIGN key (numero_documento,sigla) REFERENCES cliente.cliente(numero_documento,sigla)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table logs.log_auditoria(
	...
	constraint fk_log_audi_clie FOREIGN key (numero_documento,sigla) REFERENCES cliente.cliente(numero_documento,sigla)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table centro.area_instructor(
    ...
    constraint fk_intr_esin FOREIGN KEY (numero_documento,sigla) REFERENCES centro.intructor(numero_documento,sigla)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_area_esin FOREIGN KEY (nombre_area) REFERENCES centro.area (nombre_area)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table centro.dia_jornada(
    ...
    constraint fk_jorn_dia_inst FOREIGN key (nombre_jornada) REFERENCES centro.jornada_instructor (nombre_jornada)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_dia_jorn_hora FOREIGN KEY (nombre_dia) REFERENCES horarios.dia (nombre_dia)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create Table ficha.trimestre(
    ...
    constraint fk_jorn_trim FOREIGN KEY (sigla_jornada) REFERENCES ficha.jornada (sigla_jornada)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_nifo_trim FOREIGN KEY (nivel) REFERENCES programa.nivel_formacion (nivel)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table sede.ambiente(
    ...
    constraint fk_sede_ambi FOREIGN key (nombre_sede) REFERENCES sede.sede (nombre_Sede)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_tiam_ambi FOREIGN KEY (tipo) REFERENCES sede.tipo_ambiente(tipo)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table programa.programa (
    ...
    constraint fk_nifo_prog FOREIGN KEY (nivel) REFERENCES programa.nivel_formacion(nivel)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table programa.competencia(
    ...
    constraint fk_prog_comp FOREIGN KEY (codigo_programa,version_programa) REFERENCES programa.programa(codigo,version)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table programa.resultado_aprendizaje(
    ...
    constraint fk_comp_reap FOREIGN KEY (codigo_competencia,codigo_programa,version_programa) REFERENCES programa.competencia(codigo_competencia,codigo_programa,version_programa)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table programa.planeacion_trimestre(
    ...
    constraint fk_reap_pltr FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje(codigo_resultado,codigo_competencia,codigo_programa,version_programa)ON DELETE CASCADE ON UPDATE CASCADE,
    ...
    constraint fk_trim_pltr FOREIGN KEY (nombre_trimestre,nivel,sigla_jornada) REFERENCES ficha.trimestre (nombre_trimestre,nivel,sigla_jornada)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table proyectos.proyecto(
    ...
    constraint fk_prog_proy FOREIGN KEY (codigo_programa,version_programa) REFERENCES programa.programa(codigo,version)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table proyectos.fase (
    ...
    constraint fk_proy_fase FOREIGN key (codigo_proyecto) REFERENCES proyectos.proyecto(codigo)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table proyectos.actividad_proyecto (
    ...
    constraint fk_fase_acti FOREIGN KEY (nombre_fase,codigo_proyecto) REFERENCES proyectos.fase (nombre,codigo_proyecto)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table programa.actividad_planeacion(
    ...
    constraint fk_acti_acpl FOREIGN key (nombre_fase,numero_actividad,codigo_proyecto) REFERENCES proyectos.actividad_proyecto(nombre_fase,numero_actividad,codigo_proyecto)ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE centro.vinculacion_instructor(
    ...
    constraint fk_year_viin FOREIGN KEY (number_year) REFERENCES centro.year (number_year)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_inst_viin FOREIGN KEY (numero_documento,sigla) REFERENCES centro.intructor (numero_documento,sigla)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_vinc_viin FOREIGN KEY (tipo_vinculacion) REFERENCES centro.vinculacion(tipo_vinculacion)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table centro.disponibilidad_competencias(
    ...
    constraint fk_viin_dico FOREIGN KEY (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion) REFERENCES centro.vinculacion_instructor (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_comp_dico FOREIGN KEY (codigo_competencia,codigo_programa,version_programa) REFERENCES programa.competencia(codigo_competencia,codigo_programa,version_programa)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table centro.disponibilidad_horaria(
    ...
    constraint fk_inst_hora FOREIGN KEY (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion) REFERENCES centro.vinculacion_instructor (fecha_inicio,numero_documento,sigla,number_year,tipo_vinculacion)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_join_hora FOREIGN KEY (nombre_jornada) REFERENCES centro.jornada_instructor (nombre_jornada) ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table sede.limitacion_ambiente(
    ...
    constraint fk_ambi_liam FOREIGN KEY (numero_ambiente,nombre_sede) REFERENCES sede.ambiente (numero_ambiente,nombre_sede)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_reap_liam FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje (codigo_resultado,codigo_competencia,codigo_programa,version_programa)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table horarios.trimestre_vigente(
    ...
    constraint fk_year_vige FOREIGN KEY (number_year) REFERENCES centro.year (number_year) ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table horarios.version_horario(
    ...
    constraint fk_trvi_veho FOREIGN KEY (trimestre_programado,number_year) REFERENCES horarios.trimestre_vigente (trimestre_programado,number_year)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table ficha.ficha_has_trimestre(
    ...
    constraint fk_trim_fitr FOREIGN KEY (sigla_jornada,nivel,nombre_trimestre) REFERENCES ficha.trimestre (sigla_jornada,nivel,nombre_trimestre)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table horarios.horario(
    ...
    constraint fk_dia_hora FOREIGN KEY (nombre_dia) REFERENCES horarios.dia (nombre_dia)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_moda_hora FOREIGN KEY (nombre_modalidad) REFERENCES horarios.modalidad (nombre_modalidad)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_ambi_hora FOREIGN KEY (numero_ambiente,nombre_sede) REFERENCES sede.ambiente (numero_ambiente,nombre_sede)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_fitr_hora FOREIGN KEY (numero_ficha,sigla_jornada,nivel,nombre_trimestre) REFERENCES ficha.ficha_has_trimestre (numero_ficha,sigla_jornada,nivel,nombre_trimestre)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_veho_hora FOREIGN KEY (numero_version,number_year,trimestre_programado) REFERENCES horarios.version_horario (numero_version,number_year,trimestre_programado)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_inst_hora FOREIGN KEY (sigla,numero_documento) REFERENCES centro.intructor (sigla,numero_documento)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table ficha.ficha(
    ...
    constraint fk_exfi_fich FOREIGN KEY (nombre_Estado) REFERENCES ficha.estado_ficha (nombre_estado)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_jorn_fich FOREIGN KEY (sigla_jornada) REFERENCES ficha.jornada (sigla_jornada)ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_prog_fich FOREIGN KEY (codigo,version) REFERENCES programa.programa (codigo,version)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create table sustentacion.lista_chequeo(
    ...
    constraint fk_prog_linch FOREIGN key (codigo,version) REFERENCES programa.programa(codigo,version)ON DELETE CASCADE ON UPDATE CASCADE
);
...
create TABLE sustentacion.item_lista (
    ...
    constraint fk_lich_itli FOREIGN KEY (lista) REFERENCES sustentacion.lista_chequeo (lista) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_reap_itli FOREIGN KEY (codigo_resultado,codigo_competencia,codigo_programa,version_programa) REFERENCES programa.resultado_aprendizaje (codigo_resultado,codigo_competencia,codigo_programa,version_programa)ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE sustentacion.respuesta_grupo(
    ...
    constraint fk_itli_regr FOREIGN KEY (lista,numero_item) REFERENCES sustentacion.item_lista (lista,numero_item) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_valo_regr FOREIGN KEY (tipo_valoracion) REFERENCES sustentacion.valoracion (tipo_valoracion) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_grpr_regr FOREIGN KEY (numero_grupo,numero_ficha) REFERENCES sustentacion.grupo_proyecto (numero_grupo,numero_ficha) ON DELETE CASCADE ON UPDATE CASCADE
);
create table sustentacion.observacion_respuesta(
    ...
    constraint fk_regr_obre FOREIGN KEY (numero_grupo,numero_ficha,lista,numero_item) REFERENCES sustentacion.respuesta_grupo(numero_grupo,numero_ficha,lista,numero_item) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_clie_obre FOREIGN KEY (numero_documento,sigla) REFERENCES cliente.cliente (numero_documento,sigla) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE sustentacion.lista_ficha(
    ...
    constraint fk_fich_lifi FOREIGN KEY (numero_ficha) REFERENCES ficha.ficha (numero_ficha) ON DELETE CASCADE ON UPDATE CASCADE,
    constraint fk_lich_lifi FOREIGN KEY (lista) REFERENCES sustentacion.lista_chequeo (lista) ON DELETE CASCADE ON UPDATE CASCADE
)